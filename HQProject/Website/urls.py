...
urlpatterns = patterns('',
	...
	url(r'^view-product/(\d+)/delete-product$', views.delete_product, name='delete_product'),
	url(r'^view-product/(\d+)/product-deleted$', views.product_deleted, name='product_deleted'),
	...
	url(r'^view-stores/(\d+)/delete-store$',views.delete_store,name='delete_store'),
