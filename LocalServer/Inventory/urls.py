...
urlpatterns = patterns('',
	...
	url(r'^transaction/add_cashier_transaction$', views.add_cashier_transaction, name='add_cashier_transaction'),
	url(r'^transaction/cashier_transaction$', views.cashier_transaction, name='cashier_transaction'),
	url(r'^transaction/del_cashier_transaction$', views.del_cashier_transaction, name='del_cashier_transaction'),
	url(r'^transaction/abort_cashier_transaction$', views.abort_cashier_transaction, name='abort_cashier_transaction'),
	url(r'^transaction/special_cashier_transaction$', views.special_cashier_transaction, name='special_cashier_transaction'),
	...
	url(r'^online_transaction$', views.online_transaction, name='online_transaction'),
	url(r'^create_lcd_list$', views.create_lcd_list, name='create_lcd_list'),
